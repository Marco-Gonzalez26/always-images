...
export const AiImageComponent = () => {
  ...
  return (
    <section
      ...
      {!loading && imageUrl ? (
        <div className=' w-full top-0 bottom-0  flex flex-col justify-center items-center text-white  relative md:w-1/2 md:min-h-full  animate-fadeIn animate-delay-700'>
          <img
            className=' w-full object-contain animate-fadeIn animate-delay-1000'
            src={imageUrl}
            alt={value}
            title={value}
          />
